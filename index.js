...
class Collision {   
    ...
    enterInCollision(){
      ...
      for (let box of this.boxes) {  
          if(  (this.player.y+this.player.height > box.y && this.player.x+(this.player.width-5) > box.x && (this.player.x+15 ) < box.x+box.w && this.player.y < box.y+box.h) ) {
...
window.addEventListener('DOMContentLoaded', function () {
...

    {
       ...
       // create object
         ...
         // set image list
         images = new Array();
         images[0]="img/main_chara.png "
         images[1]="img/background.png"
         images[2]="img/interieur_git.png"
         images[3]="img/reconversion.png"
         images[4]="img/contact_me.png"
         images[5]="img/contact_me.png"
         images[6]="img/grange.png"
         images[7]="img/maison.png"
         // start preloading
         for(i=0; i<=8; i++) 
         {
   ...
   let createBluebox= new Collision(blackBoxs, ctx, player); 
